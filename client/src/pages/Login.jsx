...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary via-secondary to-accent relative overflow-hidden px-4">
      {/* Background blobs */}
      <div className="absolute top-16 left-8 w-72 h-72 bg-accent/30 rounded-full blur-3xl animate-float pointer-events-none" />
      <div className="absolute bottom-16 right-8 w-80 h-80 bg-light/20 rounded-full blur-3xl animate-float delay-300 pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-light/70 mt-1.5 text-sm">Sign in to your SkillSwap account</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              ...
              <Link to="/register" className="text-accent font-bold hover:text-secondary transition-colors">
                Create one free
              </Link>
            </p>
          </div>
